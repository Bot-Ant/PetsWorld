						...
						<div class="box row">
							<div id="info-order-[id-ordine]" class="product-data-row row">
								<div class="voice size-l">
									...
									<input type="text" id="order-code-[id-ordine]" class="input-field inactive" name="order-code" value="[id-ordine]">
								</div>
								<div class="voice size-l">
									<label for="order-total">Totale</label>
									<input type="text" id="order-total-[id-ordine]" class="input-field inactive" name="order-total" value="[totale-ordine]">
									<p id="product-price-${prd.idProdotto}-validity" class="invalid"></p>
								</div>
								<div class="voice size-l">
									<label for="order-date">Data</label>
									<input type="text" id="order-date-[id-ordine]" class="input-field inactive" name="order-date" value="[data-ordine]">
								</div>
								<div class="voice size-xl">
									<label for="order-user">Utente</label>
									<input type="text" id="order-user-[id-ordine]" class="input-field inactive" name="order-user" value="[utente-ordine]">
								</div>
							</div>
						</div>
					</div>
