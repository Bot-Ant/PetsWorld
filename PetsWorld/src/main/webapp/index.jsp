                ...
                <form action="<%=response.encodeURL("ServletCercaProdotto")%>" method="get"> 
                    ...
                    <p class="out-of-stock" id="${prd.idProdotto}_demo_2">TERMINATO</p>
							...
							<div class="text-container">
								<h2 class="price">€${prd.prezzo}</h2>
								<div class="add-to-cart">
								  <button type="submit" name="id" value="${prd.idProdotto}" onclick="aggiungiAlCarrelloDaIndex(${prd.idProdotto}, 2)"><i class="fa-solid fa-circle-plus fa-3x"></i></button>
								</div>
							</div>
						</div>
					</c:forEach>
                ...
                <form action="<%=response.encodeURL("ServletCercaProdotto")%>" method="get"> 
                    ...
                    <p class="out-of-stock" id="${prd.idProdotto}_demo_3">TERMINATO</p>
							...
							<div class="text-container">
								<h2 class="price">€${prd.prezzo}</h2>
								<div class="add-to-cart">
								  <button type="submit" name="id" value="${prd.idProdotto}" onclick="aggiungiAlCarrelloDaIndex(${prd.idProdotto},3)"><i class="fa-solid fa-circle-plus fa-3x"></i></button>
								</div>
							</div>
						</div>
					</c:forEach>
